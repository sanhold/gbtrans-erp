  ...
  useEffect(() => {
    Promise.all([
      ...
      setForm({
        ...
        afficherSignature: !!p.afficherSignature,
      });
          ...
          <div className="pf-sheet" ref={sheetRef}>
            <div className="pf-doc-head">
              ...
              <div className="pf-doc-title">
                ...
                {proforma.dossier && <div className="pf-doc-num">Dossier : <strong>{proforma.dossier.numeroPhysique || proforma.dossier.numero}</strong></div>}
            ...
            <div className="pf-meta-grid">
              ...
              <div className="pf-meta-block">
                ...
                {proforma.client?.email && <div className="pf-meta-v">{proforma.client.email}</div>}
                {proforma.client?.ncc && <div className="pf-meta-v">{proforma.client.ncc}</div>}
                {proforma.client?.pays && (
                  <div className="pf-meta-v">
                    {proforma.client.pays}
                    {proforma.client.pays.toLowerCase().includes('ivoire') && (
